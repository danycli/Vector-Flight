...
public class EventHandler extends Application {
    ...
    public void startGame() {
        ...
        HighScoreBoard.setTranslateX(stage.getWidth() - (HighScoreBoard.getLayoutBounds().getWidth() + 35));
        HighScoreRectangle.setTranslateX(stage.getWidth() - (HighScoreRectangle.getLayoutBounds().getWidth() + 35));
        ...
        gameloop = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (!playerBumped && !pauseTheGame) {
                    ...
                    //Removing the rectangles that are not on the screen anymore
                ...
                //Clearing out the Arraylists to optimize the space-time
    ...
    //Getting the selected Mod
    public void setMod(String mod) {
        gameMod = mod;
    }

    @SuppressWarnings("ConvertToTryWithResources")
    //Checking and updating the HighScore
